...
def merge_on_matched_column(
    result_df: pd.DataFrame, data_df: pd.DataFrame, key_col: str = "accession", matched_col_col: str = "matched_col"
) -> pd.DataFrame:
    """
    ...
    matched_cols = result_df[matched_col_col].dropna().unique().tolist()
